<template>
	<div>
		<el-row class="songRow">
			<el-empty description="正在加载中" v-show="!songList.length"></el-empty>
			<span class="iconfont icon-24gf-playCircle playIcon" @click="sendList()"></span>
			<el-row class="title" v-show="songList.length">
			...
			<div class="mainArea">
				<div v-for="item,index in songList" :key="index" class="songItem " @dblclick="playMusic(item.id)">
					<!-- 序号 -->
					<el-col :span="2">
						...
						<div class="songbox index_1">
							...
							<div class="nameArtist">
								...
								<div class="songArtistInfo">
									<span v-for="item,index in item.ar" :key="index" class="hover"
